...
|---------------- |---------- |---------- |------- |---------:|--------:|--------:|------:|--------:|----------:|
| ArrayCopy       | .NET 10.0 | .NET 10.0 | 100000 | 191.4 μs | 3.32 μs | 3.11 μs |  1.00 |    0.02 |   1,634 B |
| BufferBlockCopy | .NET 10.0 | .NET 10.0 | 100000 | 192.6 μs | 1.13 μs | 1.05 μs |  1.01 |    0.02 |     794 B |
|                 |           |           |        |          |         |         |       |         |           |
| ArrayCopy       | .NET 9.0  | .NET 9.0  | 100000 | 192.2 μs | 1.25 μs | 1.17 μs |  1.00 |    0.01 |   1,634 B |
| BufferBlockCopy | .NET 9.0  | .NET 9.0  | 100000 | 193.3 μs | 1.12 μs | 1.05 μs |  1.01 |    0.01 |     785 B |
...
M00_L13:
       mov       rcx,rdi
       xor       edx,edx
       call      qword ptr [7FFAB22C7D08]; System.Array.GetLowerBound(Int32)
       mov       ebp,eax
M00_L14:
       mov       rcx,rsi
       xor       edx,edx
       ...
       mov       edx,ebp
       mov       r8,rsi
       call      qword ptr [7FFAB22C7CA8]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M00_L01
...
M00_L02:
       ...
       mov       rcx,rax
       call      qword ptr [7FFAB22E7D08]
       int       3
M00_L03:
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rbp,rax
       call      qword ptr [7FFAB22E7D20]
       mov       rsi,rax
       mov       ecx,257
       mov       rdx,7FFAB1D74000
       call      qword ptr [7FFAB20B7738]
...
M00_L05:
       ...
       mov       rdx,rax
       mov       ecx,ebx
       call      qword ptr [7FFAB22E7CA8]
       int       3
M00_L06:
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFAB22E7D38]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FFAB20BFA08]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
...
M00_L13:
       mov       rcx,rdi
       xor       edx,edx
       call      qword ptr [7FFAB22D7D08]; System.Array.GetLowerBound(Int32)
       mov       ebp,eax
M00_L14:
       mov       rcx,rsi
       xor       edx,edx
       ...
       mov       edx,ebp
       mov       r8,rsi
       call      qword ptr [7FFAB22D7CA8]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M00_L01
; Total bytes of code 556
```
```assembly
...
M00_L02:
       ...
       mov       rcx,rax
       call      qword ptr [7FFAB22B7D08]
       int       3
M00_L03:
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rbp,rax
       call      qword ptr [7FFAB22B7D20]
       mov       rsi,rax
       mov       ecx,257
       mov       rdx,7FFAB1D44000
       call      qword ptr [7FFAB2087738]
...
M00_L05:
       ...
       mov       rdx,rax
       mov       ecx,ebx
       call      qword ptr [7FFAB22B7CA8]
       int       3
M00_L06:
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFAB22B7D38]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FFAB208FA08]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
; Total bytes of code 458
