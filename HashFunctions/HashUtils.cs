...
        private static readonly uint[] crc32Table = new uint[256]
        ...
        /// This uses the Jenkins One-At-A-Time hash function.
        /// </summary>
        /// <param name="value">The bytes to hash.</param>
        /// <returns>A hash code computed based on the bytes in the input.</returns>
        public static int JenkinsHash(byte[] value)
        {
        ...
        /// <summary>
        /// Computes a CRC32 on the specified string.
        /// </summary>
        /// <param name="buff">The string to process.</param>
        /// <returns>The CRC32.</returns>
        public static uint CRC32(string buff)
        {
            byte[] bytes = Encoding.Convert(Encoding.Unicode, Encoding.ASCII, Encoding.Unicode.GetBytes(buff));

            uint result = CRC32(bytes);

            return result;
        }

        /// <summary>
        /// Computes a CRC32 on the specified byte buffer.
        /// </summary>
        /// <param name="buff">The buffer to process.</param>
        /// <returns>The CRC32.</returns>
        public static uint CRC32(byte[] buff)
        {
            ...
            try
            {
                ...
                {
                    result = crc32Table[((result & 0xffff) & 0xff) ^ buff[i]] ^ (result >> 8);
                }
        ...
        /// <summary>
        /// Compute the 32-bit hash value by using .net framwork algorithm
        /// </summary>
        /// <param name="str">The data to hash.</param>
        /// <returns>The 32-bit hash value.</returns>
        public static int GetNetFrameworkHashCodeFor64Bit(string str)
        {
            unchecked
            {
                int hash1 = 5381;
        ...
        */
        public static int FNV1_32(byte[] buff)
        {
            unchecked
            {
        ...
        public static long FNV1_64(byte[] buff)
        {
            unchecked
            {
    ...
    public static class FNVConstants
    {
        ...
        public static int CreateHash(byte[] buff)
        {
            return buff.Aggregate(OffsetBasis, (r, o) => (r ^ o) * Prime);
        }
    }
}
